package com.example.food_recept.presentation.ui.home
...
import com.example.food_recept.presentation.ui.home.adapter.CategoryRecyclerAdapter
import com.example.food_recept.presentation.ui.home.adapter.FoodByCategoryRecyclerAdapter
import com.example.food_recept.presentation.ui.home.event.HomeEvent
                    ...
                    when (it) {
                        is Resource.Success -> {
                            with(binding) {
                                ...
                                tvCountry.text = it.success.area
